            ...
            <div className="main-login">
              ...
              >
                <div className="container  main-section-hero sec">
                  <div>
                    <img className="img-drops" src="./Assetss/1.gif" alt="" />
                  </div>
              ...
              <section className="scan-photo-section" id="scan-photo">
                <div className="container  main-section-hero sec">
                  ...
                  <div>
                    <img className="img-drops" src="./Assetss/2.png" alt="" />
                  </div>
                </div>
              </section>
              ...
              <section className="scan-photo-section" id="scan-photo">
                <div className="container  main-section-hero sec">
                  <div>
                    <img className="img-drops" src="./Assetss/3.png" alt="" />
                  </div>
